...
export class Exercises implements OnInit, OnDestroy {
  ...
  allExercises: Exercise[] = [
    // ── ABS ──
    {
      ...
      gifUrl: 'https://media.giphy.com/media/3o6ZtfxngKlopfRcre/giphy.gif',
...

    {
      ...
      gifUrl: 'https://media.giphy.com/media/3oKIPavRPgJYaNamPu/giphy.gif',
...

    {
      ...
      gifUrl: 'https://media.giphy.com/media/3oKIPjzfv0sI2p7fDW/giphy.gif',
    ...
    // ── FULL-BODY ──
    {
      ...
      gifUrl: 'https://media.giphy.com/media/l2JJKs3I69qfaQleE/giphy.gif',
...

    {
      ...
      gifUrl: 'https://media.giphy.com/media/l0MYAs5E2oIDT8FqU/giphy.gif',
